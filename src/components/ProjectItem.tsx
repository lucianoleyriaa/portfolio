  ...
  return (
    <div className='flex flex-col lg:flex-row gap-6 m-auto'>
      ...
      <div className='w-2/2 lg:w-1/2'>
        ...
        <p className='my-2 font-light text-sm md:text-base dark:text-gray-400 text-gray-800'>{ description }</p>
        ...
        <div className='my-4'>
          <div className="flex items-center justify-center md:justify-normal gap-4">
            ...
            <a href={ pageLink } target='_blank' className='py-1 px-2 md:py-2 md:px-4 text-white rounded-3xl bg-indigo-600 hover:bg-indigo-400 transition hover:scale-105 duration-300 ease-out'>

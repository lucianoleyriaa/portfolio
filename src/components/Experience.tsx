...
export const Experience = () => {
  return (
    <div id='experience' className='md:w-4/5 lg:w-2/3 xl:w-2/2 2xl:w-2/3 md:m-auto my-16 md:px-12 md:pt-12 md:pb-24'>
      <h3 className='text-2xl xs:w-full md:text-4xl text-center text-gray-800 dark:text-white'>Experiencia</h3>
      ...
      <div className='px-6 md:w-2/2 md:p-6 md:my-10 md:ring-1 md:ring-inset md:dark:ring-gray-600 md:rounded-xl md:dark:bg-gray-900 dark:text-white text-gray-800'>
        <div className='py-4 mb-2 md:mb-0 md:py-0'>
          <h3 className='text-lg md:text-2xl text-amber-400'><span className='font-bold'>Postcron</span> - <span className='font-light text-gray-800 dark:text-white'>Desarrollador Full Stack</span></h3>
          <span className='text-sm font-light'>Octubre 2021 - Actualidad</span>
        </div>

        <div className='md:p-4'>
          <ul className='md:p-4 list-disc text-sm dark:text-gray-400 md:dark:text-white text-gray-800 md:text-base font-light'>

...
export const Presentation = () => {
  return (
    <div className='w-1/2 h-screen m-auto p-20 py-80 flex items-center gap-8'>
      <div className='flex flex-col items-start gap-8'>
        ...
        <div className='my-3 flex items-center gap-2'>
          <a 
            ...
            target='_blank' 
            className='mr-4 flex items-center gap-2 rounded-3xl bg-indigo-500 px-4 py-2 hover:bg-indigo-400 transition hover:scale-105 duration-300 ease-out'
          >
